            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link href="/">
                                    <ApplicationLogo
                                        class="font-serif text-lg font-semibold block w-auto fill-current text-gray-800 hover:text-gray-400"
                                    />
                                </Link>
                            </div>
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('user.blogs')" :active="route().current('user.blogs')">
                                    My Blogs
                                </NavLink>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('user.blogs')" :active="route().current('user.blogs')">
                            My Blogs
                        </ResponsiveNavLink>
